									...
									<div class="col-sm-4">
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <a href="{{URL::to('chi-tiet-san-pham/'.$lienquan->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Xem Sản Phẩm</a>
                                            </div>
