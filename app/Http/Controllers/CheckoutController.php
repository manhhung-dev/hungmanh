...
class CheckoutController extends Controller
{
    ...
    public function login_customer(Request $request){
        ...
        if($result){
            ...
            Session::put('message','Mật khẩu và tài khoản sai. Nhập lại');
    ...
    public function order_place(Request $request){
        ...
        $data=array();
        $data['payment_method'] = $request->payment_option ?? 'cash';
        ...
        if($data['payment_method']=='banking'){
            ...
            Cart::destroy();
            return view('pages.checkout.cash')->with('category',$cate_product);
        }
    }
